...
function AIActions() {
  ...
  const handleExplainConcept = async (e) => {
    ...
    try {
      ...
      toast.error("Could not generate an explanation at this time");
    } finally {
      setLoadingAction(null);
    }
  };
      ...
      <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-slate-200/60 bg-linear-to-br from-slate-50/50 to-white/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-emerald-500 to-emerald-600 text-white flex justify-center items-center shadow-lg shadow-purple-500/25">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-300">
            <form action="" onSubmit={handleExplainConcept}>
              ...
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
                Enter a topic or concept from the document and get a detailed
                explanation.
              </p>
              <div className="flex items-center gap-3">
                <input
                  ...
                  name=""
                  id=""
                  className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 focus:bg-white focus:outline-none focus:border-emerald-500 focus:shadow-lg focus:shadow-purple-500/10 text-sm font-medium"
                  value={concept}
                ...
                <button
                  type="submit"
                  className="shrink-0 h-11 px-4 bg-linear-to-r from-emerald-600 to-emerald-500 text-white hover:from-emerald-600 hover:to-emerald-600 text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-purple-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
