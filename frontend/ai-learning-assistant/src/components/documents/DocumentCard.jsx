    ...
    >
      ...
      <div>
        <div className="flex items-center justify-between gap-3 mb-4">
          <div className="shrink-0 w-12 h-12 bg-linear-to-br from-emerald-500 to-cyan-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-blue-500/25 group-hover:scale-110 transition-transform duration-300">
          ...
          {document.quizCount !== undefined && (
            <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-emerald-50 rounded-lg">
              ...
              <span className="text-xs font-semibold text-emerald-700">
                {document.quizCount}{" "}
                {document.quizCount === 1 ? "Quiz" : "Quizzes"}
              </span>
            </div>
          )}
        </div>
