...
function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.error || "Failed to register. Please try again later");
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-300">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <label
                ...
                className="block text-xs font-semibold uppercase text-slate-700 tracking-wide"
              >
                Username
              </label>
              <div className="relative group">
                ...
                <input
                  ...
                  name=""
                  id="username-input"
                  className="w-full h-12 pl-12 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10"
                  value={username}
